...
<body background="registerwallpaper.jpg" height="100%" width="100%">
	<h1 align="center">This is a register page</h1>
	<form action="register.htm" method="post" class="uk-form">
		<table align="center">
			<tr>
				<td>username:</td>
